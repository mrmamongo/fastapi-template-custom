...
description = """
fastapi_template_custom API helps you do awesome stuff. 🚀
"""

app = FastAPI(
    title="fastapi_template_custom",
    description=description,
    version=read("VERSION"),
    terms_of_service="http://fastapi_template_custom.com/terms/",
    contact={
        "name": "mrmamongo",
        "url": "http://fastapi_template_custom.com/contact/",
        "email": "mrmamongo@fastapi_template_custom.com",
    },
    license_info={
        "name": "The Unlicense",
