...
# WARNING: Ensure imports from `fastapi_template_custom` comes after this line
from fastapi_template_custom import app, settings, db  # noqa
from fastapi_template_custom.cli import create_user, cli  # noqa
